<!-- GENERATED FILE — DO NOT EDIT. Source: docs/architecture/scala-code-patterns/18-compile-enforcement.md -->

# Compile-Time Enforcement

Tools enforcing patterns at compile time. Violations fail the build.
...
```scala
// models project must NOT depend on pipeline libraries
