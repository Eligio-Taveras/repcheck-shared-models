<!-- GENERATED FILE — DO NOT EDIT. Source: docs/architecture/scala-code-patterns/16-sbt-structure.md -->

# 16. SBT Project Structure

**Pattern**: Repos with publishable types + application code use `models/` + `app/` sub-projects. Pure library repos are single-project.
...
## Rules
- Multi-project: `models/` sub-project published; pipeline/app sub-projects unpublished
